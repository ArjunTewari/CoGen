...
if os.path.exists(cred_path):
    ...
    # For Replit, we might need to use environment variables directly
...
async def generate_content(request: GenerationRequest, user_data: dict = Depends(verify_firebase_token)):
    try:
        ...
        if words_remaining < request.word_count:
        ...
        Perplexity_Agent = Agent(
            ...
            tools=[PerplexityTool(token=os.environ.get("PERPLEXITY_API_TOKEN", "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"))],
        )
        ...
        News_Agent = Agent(
            ...
            tools=[NewsAPITool(api_key=os.environ.get("NEWS_API_KEY", "00b977b511e8492ba9c69f7bbc319fc2"))],
        )
        ...
        # Update user's words remaining
        new_words_remaining = words_remaining - word_count
        user_ref.update({
            "wordsRemaining": new_words_remaining,
        ...
        return {
            ...
            "message": "Draft content generated. Please review and provide final feedback.",
